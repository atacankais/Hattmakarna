...
private static InfDB idb;
    ...
    public void fillBoxWithType(){
     
        String question = "Select Type from material";
        ArrayList<String> allTypeName;
        
        try {
            allTypeName = idb.fetchColumn(question);
