...
private static InfDB idb;
    ...
    private void initComponents() {
        ...
        registreraMaterialButton = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jLabel1.setText("Registrera nytt material");

        jLabel2.setText("Ange material:");
        ...
        registreraMaterialButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                registreraMaterialButtonActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(materialTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap(143, Short.MAX_VALUE))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(registreraMaterialButton)
                .addGap(29, 29, 29))
        );
    ...
    private void registreraMaterialButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registreraMaterialButtonActionPerformed
     try {
         
       String material = materialTextField.getText();
       String type = typeBox.getSelectedItem().toString();
       
       String createNewMaterial = "Insert into material (Material_name, Type) values ('" + material +"','" + type +"')";
       idb.insert(createNewMaterial);
        
       JOptionPane.showMessageDialog(null, "Nytt material registrerat");
     } catch (InfException e) {
         
     }
        
        
    }//GEN-LAST:event_registreraMaterialButtonActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistreraMaterial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton registreraMaterialButton;
